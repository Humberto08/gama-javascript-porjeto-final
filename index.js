// Bibliotece para capturar inputs de texto do usuário no console
...
function separaIngredientes(pedido) {
    let ingredientes_base = 'ovo, leite, farinha, fermento';
...
function entregapedido(bolo, preco) {
    ...
    prompt('Seu pedido ficou em R$ ' + preco + '. Quando terminar de comer clique em ENTER para pagar...');
}


// Receber dinheiro
function receberDinheiro() {
    // Rceber dinheiro do cliente
    ...
    prompt('Muito obrigado volte sempre!')
}
